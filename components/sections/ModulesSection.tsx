...
export default function ModulesSection() {
  ...
  return (
    <section ref={ref} id="program" style={{ position: "relative", zIndex: 10, padding: "120px 24px", textAlign: "center" }}>
      <div className="section-container">
        ...
        <div className="mod-grid">
          {modules.map((m, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.4, delay: 0.04 + i * 0.05 }}
              className="card" style={{ padding: "24px 20px", textAlign: "left", position: "relative", overflow: "hidden" }}>
